  ...
  <el-dialog ref="dialog" :title="title"  :visible.sync="dialogFormVisible" width="442px">
    <el-form :model="form" :rules="rules" ref="commForm" :inline="true">
      ...
      <el-form-item label="性别：" prop="sex">
        <el-input v-model="form.sex" autocomplete="off" placeholder="请输入性别"></el-input>
      </el-form-item>
...
import { saveData} from '@/api/appuser'
...
export default {
  ...
  data () {
    ...
    var validatenickSex= (rule, value, callback) => {
      if (value === '') {
    ...
    return {
      ...
      rules: {
        ...
        sex:[
          { validator: validatenickSex, trigger: 'blur' },
          {pattern:/^['男' | '女']$/,message: '性别格式错误',trigger: 'blur'}
          ],
        phone:[
